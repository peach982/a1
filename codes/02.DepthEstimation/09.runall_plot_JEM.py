...
class generate:
	...
	def __init__ (self,path='/Lustre03/data/tangqianzi/Gut_unroll/outputs/'):
		...
		self.path = path
		self.jobfolder = 'runall_09stepjobs'
...
python /Lustre03/data/tangqianzi/Gut_unroll/outputs/09.plot_JEM.py 6 '''+mysample

	        print>>myoutput1,'/usr/bin/perl /Lustre01/tangqianzi/software/scripts/qsub-sgenew.pl --queue tangqianzi --maxjob 200 --lines 4 --jobprefix step9 --convert no --resource nodes=1:ppn=1,mem=20g '+self.path+'/'+self.jobfolder+'/alljobs_dump.sh'
