...
class generate:
	...
	def __init__ (self,path='/Lustre03/data/tangqianzi/Gut_unroll/outputs/',name='6PC_3',cutoff='6'):
	...
	def generate (self):
	        ...
	        mydatacounts={'g2':1,'g3':1,'g4':1,'g5':1}
...
allcolors1<-c(rep("#99CCCC",'''+str(mydatacounts['g2'])+'''),rep("#66CCFF",'''+str(mydatacounts['g3'])+'''),rep("#990066",'''+str(mydatacounts['g4'])+'''),rep("pink",'''+str(mydatacounts['g5'])+'''))
...
def main():
	...
	#generate(name=pathandfiles[0]).generate()
